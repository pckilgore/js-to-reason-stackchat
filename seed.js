...
const messages = [
  ...
  { authorId: id(), content: "I like ReasonML!", channelId: 1 },
  { authorId: id(), content: "I like Reason-React!", channelId: 1 },
  { authorId: id(), content: "I like writing web apps!", channelId: 2 },
  { authorId: id(), content: "You should learn ReasonML!", channelId: 2 },
  { authorId: id(), content: "ReasonML is pretty great!", channelId: 2 },
